...
# ======= my notes ========
# en_core_web_sm is less accurate (the numbers are lower, although they are related to each other) than en_core_web_md
# i suppose this is because the sm version is based on a smaller dataset
